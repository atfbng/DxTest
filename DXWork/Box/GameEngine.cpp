...
void GameEngine::UpdateObjectCBs(const GameTimer& gt) {
...
void GameEngine :: BuildShadersAndInputLayout() {
...
void GameEngine::BuildFrameResources()
{
...
void GameEngine::BuildDescriptorHeaps()
{
